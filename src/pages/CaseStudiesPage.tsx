...
const CASE_STUDIES: CaseStudy[] = [
	{
		...
		image: 'src/assets/images/case_studies/the-jopwell-collection-u5pAYGDWD54-unsplash.jpg', 
	...
	},
	{
		...
		image: 'src/assets/images/case_studies/Kids.jpg',
	...
	},
	{
		...
		image: 'src/assets/images/case_studies/Fairfields.webp',
	...
	},
	{
		...
		image: 'src/assets/images/case_studies/download.webp',
				...
				<div className="animate-fade-in-up">
					...
					<div className="border-t border-gray-800 pt-12 pb-8 flex flex-col md:flex-row items-center justify-between gap-6">
						...
						<a 
							...
							// Changed classes to match the 'Back to all case studies' button
