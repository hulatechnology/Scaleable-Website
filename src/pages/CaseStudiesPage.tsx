...
    image: factor6Image, // <-- Using imported variable
...
    image: hulaImage, // <-- Using imported variable
...
    image: fairfieldImage, // <-- Using imported variable
...
    image: wcedImage, // <-- Using imported variable
